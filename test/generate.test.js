...
describe(helpers.getTestDialectTeaser("sequelize-auto"), function() {
  ...
  var setupModels = function(self, callback) {
    ...
    var execString = "node " + path.join(__dirname, "..", "bin", "sequelize-auto") + " -o \"" + testConfig.directory + "\" -O \"" + testConfig.extendedModelsDirectory + "\" -d " + config.database + " -h " + config.host;
  ...
  describe("should be able to require", function(){
    ...
    it("the model files...", function(done){
      var HistoryLogs = this.sequelize.import(path.join(testConfig.directory , 'HistoryLogs' + '.autogenerated'));
      var ParanoidUsers = this.sequelize.import(path.join(testConfig.directory, 'ParanoidUsers' + '.autogenerated'));
      var Users = this.sequelize.import(path.join(testConfig.directory, 'Users' + '.autogenerated'));
    ...
    it("the extended model files...", function(done){
      var HistoryLogs = this.sequelize.import(path.join(testConfig.extendedModelsDirectory , 'HistoryLogs'));
      var ParanoidUsers = this.sequelize.import(path.join(testConfig.extendedModelsDirectory , 'HistoryLogs'));
      var Users = this.sequelize.import(path.join(testConfig.extendedModelsDirectory , 'HistoryLogs'));

      expect(HistoryLogs).to.exist;
      expect(ParanoidUsers).to.exist;
